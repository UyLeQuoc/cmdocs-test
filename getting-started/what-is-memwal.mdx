...
<Cards>
  ...
  <Card title="AI-Agent Ready" icon="Bot">
...
<Cards>
  ...
  <Card title="Ask" icon="MessageCircle">
...
<Cards>
  ...
  <Card title="Delegate Access" icon="Users">
...
<Cards>
  <Card title="Concepts" description="Memory spaces, ownership and delegates." href="/fundamentals/concepts/memory-space" icon="Lightbulb" />
  <Card title="Architecture" description="System overview, component responsibilities, and data flow." href="/fundamentals/architecture/core-components" icon="Building" />
  <Card title="SDK" description="Quickstart, usage patterns, AI integration, and examples." href="/sdk/quick-start" icon="Package" />
  <Card title="Relayer" description="Managed relayer, installation and setup, self-hosting." href="/relayer/overview" icon="Radio" />
  <Card title="Smart Contract" description="Onchain ownership model, delegate key management, permissions." href="/contract/overview" icon="ScrollText" />
  <Card title="Indexer" description="Event indexing, onchain events, database sync." href="/indexer/purpose" icon="Search" />
  <Card title="Reference" description="SDK API, relayer API, configuration, environment variables." href="/sdk/api-reference" icon="BookOpen" />
</Cards>
