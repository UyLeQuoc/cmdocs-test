...
<Cards>
  ...
  <Card title="SDK" icon="Package" href="/sdk/quick-start">
    Quickstart, usage patterns, AI integration, and examples
  </Card>
  <Card title="Relayer" icon="Radio" href="/relayer/overview">
    Managed relayer, installation and setup, self-hosting
  </Card>
  <Card title="Smart Contract" icon="ScrollText" href="/contract/overview">
    Onchain ownership model, delegate key management, permissions
  </Card>
  <Card title="Indexer" icon="Search" href="/indexer/purpose">
    Event indexing, onchain events, database sync
  </Card>
  <Card title="Reference" icon="BookOpen" href="/sdk/api-reference">
